...
namespace HotelSys.Models
{
    public partial class Hotel_alkheerContext : DbContext
    {
        ...
        public virtual DbSet<HotelsBranchTable> HotelsBranchTables { get; set; }
        ...
        public virtual DbSet<OrgsTable> OrgsTables { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                // optionsBuilder.UseSqlServer("Data Source=DESKTOP-47H6HKQ;Initial Catalog=Hotel_alkheer;Integrated Security=False;User ID=sa;Password=Ss------123456;");
                //Hotel_alkheer

                optionsBuilder.UseSqlServer("Server=95.216.218.251,12356;Database=Hotel_talal_2;Trusted_Connection=False;MultipleActiveResultSets=true;User ID=sa;Password=orax055266");
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AreaTable>(entity =>
            {
                ...
                entity.Property(e => e.NameArNormalized).HasColumnName("name_ar_normalized");

                entity.Property(e => e.NameArTashkeel).HasColumnName("name_ar_tashkeel");

                entity.Property(e => e.NameEn)
                    .HasMaxLength(200)
                    .HasColumnName("name_en");

                entity.Property(e => e.NameEnNormalized).HasColumnName("name_en_normalized");
            ...
            modelBuilder.Entity<CityTable>(entity =>
            {
                ...
                entity.HasOne(d => d.IdCountryNavigation)
                    ...
                    .HasConstraintName("FK_city_table_country_table");
            });
            ...
            modelBuilder.Entity<DetialsStatusTable>(entity =>
            {
                ...
                entity.HasOne(d => d.IdStatusBeforeNavigation)
                    .WithMany(p => p.InverseIdStatusBeforeNavigation)
                    .HasForeignKey(d => d.IdStatusBefore)
                    .HasConstraintName("FK_detials_status_table_detials_status_table");
            });
            ...
            modelBuilder.Entity<HotelsBranchTable>(entity =>
            {
                entity.ToTable("hotels_branch_table");
                ...
                entity.HasOne(d => d.IdCountryNavigation)
                    .WithMany(p => p.HotelsBranchTables)
                    .HasForeignKey(d => d.IdCountry)
                    .HasConstraintName("FK_hotels_table_country_table");

                entity.HasOne(d => d.IdOrgNavigation)
                    .WithMany(p => p.HotelsBranchTables)
                    .HasForeignKey(d => d.IdOrg)
                    .HasConstraintName("FK_hotels_branch_table_org_table");
            });
            ...
            modelBuilder.Entity<OrgsTable>(entity =>
            {
                entity.ToTable("orgs_table");
                ...
                entity.HasOne(d => d.IdCountryNavigation)
                    .WithMany(p => p.OrgsTables)
                    .HasForeignKey(d => d.IdCountry)
                    .HasConstraintName("FK_org_table_country_table");
            });
