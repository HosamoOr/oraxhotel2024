    ...
    public class EmployeeList
    {
        ...
        public List<DataItem> InitializeList()
        {
            return new List<DataItem>() {
                new DataItem(1, 101, "حسام ------", "Dr.", "Vice President, Sales"),
                new DataItem(1, 102, "محمد الجعيدي", "Ms.", "Sales Representative"),
                new DataItem(1, 103, "اوراكس سوفت", "Mr.", "Sales Representative"),
                new DataItem(1, 104, "عبدالفتاح العمراني", "Ms.", "Sales Representative"),
                new DataItem(1, 105, "هاشم", "Dr.", "Sales Coordinator"),
                new DataItem(2, 201, "موسى", "Ms.", "Sales Representative"),
