...
var options = {
 ...
 var options = {
  ...
  colors: ["rgba(42, 118, 244, .18)", '#2a76f4', "rgba(251, 182, 36, .6)","#00ff00"],
  series: [{
      name: 'صيانة',
      ...
      , {
          name: 'فارغ',
          data: [20, 30, 40, 33, 45, 48, 52, 33, 5]
      }
     ],
  xaxis: {
      categories: ['يناير', 'فبراير', 'مارس', 'ابريل', 'مايو', 'يوليو', 'يونيو', 'اغسطس', 'سبتمبر'],
      axisBorder: {
          show: true,
          color: '#bec7e0',
        },  
...
var options = {
  ...
  title: {
      text: 'حالة الشقق الاسبوعية 14-6-2022',
      floating: true,
      offsetY: 350,
      align: 'center',
      style: {
...
//
  ...
  var options = {
    ...
    labels: ["محجوز", "فارغ", "نظافة","صيانة"],
      colors: ["#ff0000", "#00FF00","#FFA500","#808080"],
    responsive: [{
        breakpoint: 600,
        options: {
            chart: {
