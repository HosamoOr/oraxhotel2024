...
namespace HotelSys.Controllers
{
    ...
    [Authorize]
    public class HomeCancelReceptionController : Controller
    {
        int idsub = 1;
        private readonly HotelAlkheerDB _db;

        public HomeCancelReceptionController(HotelAlkheerDB context)
        {
            _db = context;
        }
            ...
            public async Task<ActionResult> GetDataFarz1Async(JqueryDatatableParam param, int id)
        {
           ...
           // List<ReceptionViewModel> li = rs.List(1);
              ...
              var  model = await rs.ListCancleDT(idsub, param);
