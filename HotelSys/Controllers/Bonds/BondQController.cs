...
{
    [Authorize]
    public class BondQController : Controller
    {
        private readonly HotelAlkheerDB _db;

        public BondQController(HotelAlkheerDB context)
        {
            _db = context;
        }
        ...
        [NoDirectAccess]
        public async Task<ActionResult> Create(BondViewModel transactionModel)
        {
            try
            {
                ...
                else
                {
                    ...
                    if (transactionModel.IdReception == null)
                    {
                        ...
                        if (inRoom.Id != 0)
                        {
                            ...
                            transactionModel.Note = " (سند قبض مقابل ايجار الشقة " + inRoom.RoomModel.NameR + "(" + inRoom.IdRoom + ") ";
                        }
                    }
        ...
        public async Task<IActionResult> AddOrEdit(long id = 0)
        {
            ...
            long idBoxAccountFrom = Static_Accounts.Main_Box;
        ...
        public async Task<IActionResult> AddOrEdit(long id, BondViewModel transactionModel)
        {
           ...
           // 
            ...
            if (ModelState.IsValid )
            {
                ...
                transactionModel.IdAccount = transactionModel.id_accountTo;
        ...
        public async Task<ActionResult> GetDataAsyncAll(JqueryDatatableParam param)
        {
            ...
            var modell = await gs.ListDT(param,"1");
