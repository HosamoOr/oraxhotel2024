...
{
    [Authorize]
    public class BondEXWithItmController : Controller
    {
        private readonly HotelAlkheerDB _db;

        public BondEXWithItmController(HotelAlkheerDB context)
        {
            _db = context;
        }
        ...
        {
            var acc = new List<ItemsExpensesTable>();

          
                acc.Add(new ItemsExpensesTable
                {
                    Id = -1,
                    Name = "اختر بند المصروف"

                });
           
            acc.AddRange(_db.ItemsExpensesTables.ToList());
            ...
            if (id == 0)
            {
                ViewData["IdAccount"] = new SelectList(acc, "IdAccount", "Name");
            ...
            else
            {
              ...
              //  model.id_accountForm = model.IdAccount;
                ...
                ViewData["IdAccount"] = new SelectList(acc, "IdAccount", "Name", model.id_accountForm);
                ViewData["IdBoxAccount"] = new SelectList(boxAccount, "Id", "Name", idBoxAccountTo);
        ...
        public async Task<IActionResult> AddOrEdit(long id, BondViewModel transactionModel)
        {
           ...
           // 
            ...
            if (ModelState.IsValid )
            {
                ...
                var idItmEx = _db.ItemsExpensesTables.Where(x => x.IdAccount == transactionModel.IdAccount).FirstOrDefault();


                transactionModel.IdItemExpenses = idItmEx.Id;
        ...
        public async Task<ActionResult> GetDataAsyncAll(JqueryDatatableParam param)
        {
            ...
            var modell = await gs.ListExWithItem(param,"2");
